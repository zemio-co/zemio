...
// @ts-nocheck 
/*
 * This file exports the `BankingDetails` model and its related types.
 *
...
export type GetBankingDetailsAggregateType<T extends BankingDetailsAggregateArgs> = {
      [P in keyof T & keyof AggregateBankingDetails]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBankingDetails[P]>
    : Prisma.GetScalarType<T[P], AggregateBankingDetails[P]>
}
...
export type GetBankingDetailsGroupByPayload<T extends BankingDetailsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BankingDetailsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BankingDetailsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BankingDetailsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BankingDetailsGroupByOutputType[P]>
      }
    >
  >
...
export type BankingDetailsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BankingDetailsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BankingDetailsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BankingDetails'], meta: { name: 'BankingDetails' } }
  /**
   ...
   * })
  **/
  count<T extends BankingDetailsCountArgs>(
    args?: Prisma.Subset<T, BankingDetailsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BankingDetailsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BankingDetailsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BankingDetailsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBankingDetailsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
